  ...
  return (
    <div className="w-full h-full py-6 px-4 flex flex-col gap-3">
      ...
      <div className="flex flex-row w-full items-center justify-between">
        {" "}
        {/* Title */} {/* Info block: developer contact */} {/* Icon */}{" "}
        <Link
          href={"/"}
          prefetch={true}
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <Link
          href="/practice"
          prefetch={false}
          /* < Практики могут динамически создаваться в момент префетча */ className=" py-8 px-4 w-full flex flex-col items-start justify-start gap-1 bg-[#50EBFF] text-neutral-800 rounded-4xl transition active:scale-95 "
        >
          {" "}
